...
const Footer = () => {
  return (
    <footer className="bg-incubator-dark text-white py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold">Symbiotes Incubator</span>
            </div>
            <p className="text-gray-300 mb-4 max-w-md">
              Removing the guesswork from startup success with mentorship, networking, and real-world business validation.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#program" className="text-gray-300 hover:text-white transition-colors">Timeline</a></li>
              <li><a href="#features" className="text-gray-300 hover:text-white transition-colors">Features</a></li>
              <li><a href="#mentors" className="text-gray-300 hover:text-white transition-colors">Mentors</a></li>
              <li><a href="#apply" className="text-gray-300 hover:text-white transition-colors">Apply Now</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-6">
              <Button className="bg-white text-incubator-dark hover:bg-gray-200">Join Our Newsletter</Button>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-700 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-300 text-sm mb-4 md:mb-0">
            © {new Date().getFullYear()} Symbiotes Incubator. All rights reserved.
          </p>
